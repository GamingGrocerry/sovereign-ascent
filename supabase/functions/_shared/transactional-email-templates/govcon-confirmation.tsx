...
interface GovConConfirmationProps {
  name?: string
}

const GovConConfirmationEmail = ({ name }: GovConConfirmationProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>We've received your federal advisory inquiry — {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We've received your federal advisory inquiry and a member of our team will review your requirements. You can expect a response within 2 business days.
        </Text>
        <Text style={text}>
          Our federal advisory practice covers FAR/DFARS compliance, CMMC preparation, CTIP program development, DCAA/DCMA audit readiness, and subcontractor flow-down management.
        </Text>
        <Text style={text}>
          While you wait, explore our GovCon compliance tools and insights:
        </Text>
        <Section style={ctaSection}>
          <Button href="https://elevateqcs.com/govcon" style={ctaButton}>
            GovCon Resources
          </Button>
        </Section>
        <Hr style={divider} />
...
export const template = {
  component: GovConConfirmationEmail,
  subject: 'We\'ve received your federal advisory inquiry — ElevateQCS',
  displayName: 'GovCon Confirmation',
