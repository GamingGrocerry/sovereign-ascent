...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your secure login link for ElevateQCS</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Select the button below to access your account. This link will expire shortly.</Text>
        <Button style={button} href={confirmationUrl}>Log In to ElevateQCS</Button>
        <Text style={footer}>If you did not request this link, no action is required.</Text>
        <Section style={divider} />
