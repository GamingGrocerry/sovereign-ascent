...
const assetModules = import.meta.glob(
  ["@/assets/mjc-*.jpg", "@/assets/govcon-*.jpg", "@/assets/startup-*.jpg", "@/assets/alliant3-*.jpg", "@/assets/ctip-*.jpg", "@/assets/cmmc-*.jpg", "@/assets/compliance-*.jpg", "@/assets/contract-*.jpg", "@/assets/logistics-*.jpg", "@/assets/subcontractor-*.jpg", "@/assets/cross-border-*.jpg", "@/assets/far-*.jpg", "@/assets/pws-*.jpg", "@/assets/96-*.jpg", "@/assets/iso-*.jpg", "@/assets/maturity-*.jpg", "@/assets/oconus-*.jpg", "@/assets/osha-*.jpg", "@/assets/security-*.jpg", "@/assets/insight-*.jpg", "@/assets/cbam-*.jpg", "@/assets/scope3-*.jpg", "@/assets/environmental-*.jpg", "@/assets/unified-*.jpg", "@/assets/midmarket-*.jpg", "@/assets/international-*.jpg", "@/assets/ai-*.jpg", "@/assets/four-*.jpg", "@/assets/cs3d-*.jpg", "@/assets/eu-*.jpg", "@/assets/quality-*.jpg", "@/assets/qms-*.jpg"],
