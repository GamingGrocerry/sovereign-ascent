...
Two DFARS clauses govern CMMC flow-down obligations, and understanding their distinct functions is essential. [DFARS 252.204-7012](https://www.acquisition.gov/dfars/252.204-7012-safeguarding-covered-defense-information-and-cyber-incident-reporting.html) requires flow-down of cybersecurity safeguarding obligations — the foundational requirement to protect Covered Defense Information using NIST SP 800-171 controls and report cyber incidents within 72 hours. [DFARS 252.204-7021](https://www.acquisition.gov/dfars/252.204-7021-contractor-compliance-with-the-cybersecurity-maturity-model-certification-level-requirement.html) — the CMMC contract clause effective November 10, 2025 — requires Prime contractors to ensure subcontractors achieve the appropriate CMMC certification level before CUI or FCI is flowed down to them. Both clauses apply, but it is 7021 that specifically creates the CMMC certification flow-down obligation. This is not discretionary. It is a contractual requirement that carries the same enforcement weight as the Prime's own compliance obligations.
...
- **CMMC rulemaking is finalized.** The 48 CFR rule took effect November 10, 2025. As of February 1, 2026, DFARS 7019 and 7020 were eliminated under the FAR overhaul — contractors now fulfil assessment obligations exclusively through [DFARS 252.204-7021](https://www.acquisition.gov/dfars/252.204-7021-contractor-compliance-with-the-cybersecurity-maturity-model-certification-level-requirement.html). [DFARS 252.204-7012](https://www.acquisition.gov/dfars/252.204-7012-safeguarding-covered-defense-information-and-cyber-incident-reporting.html) remains unchanged and in full force. New solicitations are incorporating CMMC requirements as evaluation criteria.
